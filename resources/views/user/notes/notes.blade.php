...
<div class="container-fluid rounded-bottom bg-white py-3 px-3">
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr >
                <td>
                    {{-- <a href="{{ route('edit_account', [$not->id]) }}">{{ $not->tytle ?? 'Untitled Note' }}</a> --}}
                ...
                <td>
                        <a data-toggle="modal" data-target="#create_notes"  class="text-primary notes_title_content" data-name="{{$not->title??"Untitled Note"}}">
